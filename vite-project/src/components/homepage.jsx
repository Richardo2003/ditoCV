...
<section className="main-section">
  <div className="left-part">
    ...
    <div className="education-container">
      ...
      <div className="course">
        <h2 className="education-title">Elementary School</h2>
        <h5 className="college-name">GMIM PINOKALAN</h5>
        <p className="education-date">2009 - 2015</p>
      </div>
      <div className="course">
        <h2 className="education-title">Junior High School </h2>
        <h5 className="college-name">NEGERI 1 BITUNG</h5>
        <p className="education-date">2015 - 2018</p>
      </div>
      <div className="course">
        <h2 className="education-title">Senior High School </h2>
        <h5 className="college-name">NEGERI 1 BITUNG</h5>
      ...
      <div className="skill">
        ...
        <div className="right-skill">
          <div className="outer-layer">
            <div className="inner-layer" style={{width: '90%'}} />
          </div>
        </div>
      </div>
      <div className="skill">
        ...
        <div className="right-skill">
          <div className="outer-layer">
            <div className="inner-layer" style={{width: '70%'}} />
          </div>
        </div>
      </div>
      <div className="skill">
  ...
  <div className="right-part">
    ...
    <div className="references-container">
      <h2 className="title text-left">achievments</h2>
      <div className="references">
        <div className="left-references">
          <h4 className="name"></h4>          
          <img src="img/HR.png" alt width="190" height="140"/>
          <div className="phone">
        ...
        <div className="right-references"> 
          <h4 className="name">HackerRank</h4>
          <p className="company-name">30 SEPTEMBER 2023</p>
          <div className="phone">
            <div className="phone-text"> CV
              <p></p>
              <p></p>
            </div>
            <div className="phone-number">
